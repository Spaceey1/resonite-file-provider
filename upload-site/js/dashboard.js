document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadInventories() {
        ...
        try {
            ...
            data.results.forEach(inventory => {
                ...
                inventoryElement.innerHTML = `<i class="fas fa-box"></i> ${inventory.name}  <div><button class="side-btn btn-small side-btn-danger delete-item-side" data-id="${inventory.id}"><i class="fas fa-trash"></i></button></div>`;     
    ...
    function renderFolders(folders) {
            ...
            folders.forEach(folder => {
                ...
                if (deleteButton) {
                    deleteButton.addEventListener('click', (e) => {
                        e.stopPropagation();
                        // Show delete confirmation
                        showDeleteConfirmation(folder.id, folder.name, 'folder');
                    });
                }
        ...
        elements.folderTree.appendChild(folderContainer);
