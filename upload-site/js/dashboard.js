        ...
        if (folders.length === 0) {
            ...
            folders.forEach(folder => {
                ...
                folderElement.innerHTML = `
                    <i class="folder-icon"></i><div class="folder-name"> ${folder.name}  <button class="btn btn-small btn-danger delete-item" data-id="${folder.id}"><i class="fas fa-trash"></i></button>
                `;
                // Add event listeners for item actions
